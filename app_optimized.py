...
# Set page config
st.set_page_config(
    page_title="DeepSeek PDF Processor - Optimized",
    layout="wide",
...
def load_model():
    """Load the local DeepSeek model with optimized settings"""
    try:
...
def extract_text_from_pdf(pdf_file):
    """Optimized PDF text extraction - faster method selection"""
    try:
...
def query_local_model_optimized(prompt, max_new_tokens=100):
    """OPTIMIZED: Fast AI model query with greedy decoding"""
    try:
...
st.markdown('<h1 class="main-header">⚡ DeepSeek PDF Processor - OPTIMIZED</h1>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">🔒 Process German PDFs with your local DeepSeek model - 100% Offline & Private - SPEED OPTIMIZED</p>', unsafe_allow_html=True)
...
<div class="info-card">
    ...
    <p style="margin-bottom: 0;">
        Extract structured data from German quotations and invoices using optimized 
...
with st.sidebar:
    ...
    if not st.session_state.model_loaded:
        ...
        <div class="success-card">
            ...
            <p style="margin-bottom: 0;">🚀 Optimized for maximum speed!</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with st.expander("Click to see optimizations", expanded=False):
        ...
        **Performance Improvements:**
        ...
        - ✅ **Optimized model parameters** (removed overhead)
...
if not st.session_state.model_loaded:
    ...
    uploaded_files = st.file_uploader(
        "📁 Choose German PDF files (OPTIMIZED for speed)",
        type="pdf",
    ...
    if uploaded_files:
        ...
        if st.button("⚡ Process PDFs (OPTIMIZED)", type="primary"):
                ...
                with st.spinner(f"⚡ Fast processing {uploaded_file.name}..."):
                    ...
                    if pdf_text is None:
                        ...
                        with st.spinner("⚡ Fast field extraction..."):
                            ...
                            fields_response = query_local_model_optimized(full_prompt, max_new_tokens=80)
                        ...
                        if not skip_tables:
                            ...
                            with st.spinner("⚡ Fast table extraction..."):
                                ...
                                table_response = query_local_model_optimized(full_table_prompt, max_new_tokens=150)
            ...
            <div class="success-card" style="text-align: center; margin: 2rem 0;">
                ...
                <p style="font-size: 1.2rem;">All documents processed with optimized speed</p>
...
<div class="info-card" style="text-align: center; margin-top: 3rem;">
    ...
    <p style="margin-bottom: 0;"><strong>✓ Optimized for maximum processing speed</strong></p>
